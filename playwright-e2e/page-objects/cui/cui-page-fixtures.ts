...
export const cuiPageFixtures = {
  ...
  cui_startAppealPage: async ({ determinePage }, use) => {
    const cui_startAppealPage = new StartAppealPage(determinePage);
    await use(cui_startAppealPage);
  },
  cui_signInPage: async ({ determinePage }, use) => {
    const cui_signInPage = new SignInPage(determinePage);
    await use(cui_signInPage);
  },
  cui_appealOverviewPage: async ({ determinePage }, use) => {
    const cui_appealOverviewPage = new AppealOverviewPage(determinePage);
    await use(cui_appealOverviewPage);
  },
  cui_aboutAppealPage: async ({ determinePage }, use) => {
    const cui_aboutAppealPage = new AboutAppealPage(determinePage);
    await use(cui_aboutAppealPage);
  },
  cui_inTheUkPage: async ({ determinePage }, use) => {
  ...
  cui_homeOfficeReferenceNumberPage: async ({ determinePage }, use) => {
