...
export class RequestResponseReviewApi {
  ...
  private readonly eventName = 'requestResponseReview';
  ...
  public async submitEvent(options: RequestResponseReviewEventType): Promise<void> {
    ...
    const expectedKeysInEventPayload = ['isAdmin', 'sendDirectionDateDue', 'sendDirectionExplanation', 'sendDirectionParties'];
